...
class App(UuidAuditedModel):
    ...
    def create(self, *args, **kwargs):
        ...
        limit = Limit.objects.create(owner=self.owner, app=self, memory={})
        Release.objects.create(version=1, owner=self.owner, app=self, config=config, build=build, limit=limit)
...
class Release(UuidAuditedModel):
    ...
    def new(self, user, config=None, build=None, limit=None, summary=None, source_version='latest'):
        """
